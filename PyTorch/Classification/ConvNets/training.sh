...
LOGFILE=run.log.${CURRENTDATE}

SECONDS=0

#rocprof --obj-tracking on --hip-trace --roctx-trace -d rocout \
python3.6 ./multiproc.py --nproc_per_node 2 ./main.py /data/imagenet --raport-file raport.json -j5 -p 100 \
    ...
    -c fanin --label-smoothing 0.1 --workspace logs/checkpoints -b 64 --optimizer-batch-size 1024 --lr 2.024 --mom 0.875 --lr-schedule cosine --epochs 1 --warmup 8 --wd 6.103515625e-05 \
